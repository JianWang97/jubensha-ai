...
# 文件上传相关路由
@router.post("/upload/cover", summary="上传封面图片")
...
@router.post("/upload/avatar", summary="上传角色头像")
...
@router.post("/upload/evidence", summary="上传证据图片")
...
@router.post("/upload/scene", summary="上传场景背景图")
