...
Revision ID: 627e38bde922
Revises: 
Create Date: 2025-08-05 22:15:12.773740
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.String(length=20), nullable=False, comment='游戏状态: waiting, playing, finished, cancelled'),
    sa.Column('current_phase', sa.String(length=50), nullable=True, comment='当前游戏阶段'),
    sa.Column('max_players', sa.Integer(), nullable=False, comment='最大玩家数'),
    sa.Column('current_players', sa.Integer(), nullable=False, comment='当前玩家数'),
    sa.Column('game_data', sa.JSON(), nullable=True, comment='游戏数据(JSON格式)'),
    ...
    sa.Column('session_id', sa.Integer(), nullable=False, comment='游戏会话ID'),
    sa.Column('user_id', sa.Integer(), nullable=False, comment='用户ID'),
    sa.Column('character_id', sa.Integer(), nullable=True, comment='角色ID'),
    sa.Column('role', sa.String(length=20), nullable=False, comment='角色类型: host, player'),
    sa.Column('status', sa.String(length=20), nullable=False, comment='参与状态: joined, playing, finished, left'),
    sa.Column('is_winner', sa.Boolean(), nullable=False, comment='是否获胜'),
