...
export interface GameEventItem { id:number; session_id:string; event_type:string; character_name?:string; content:string; tts_file_url?:string; timestamp:string }
